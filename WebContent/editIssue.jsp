        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 clean-superblock" id="contact">
                    ...
                    <form  enctype="multipart/form-data" method="post" accept-charset="utf-8" class="contact-form"  action="doEditIssue?articleId=${requestScope.editArticle.id} ">
                    <label>文章标题</label>
                        <input type="text" name="title" id="contact-name" placeholder="title" class="form-control input-lg"  value="${requestScope.editArticle.title}">
                        ...
                        <textarea rows="10" name="content" id="contact-body" placeholder="Content" class="form-control input-lg"  > ${requestScope.editArticle.content} </textarea>
